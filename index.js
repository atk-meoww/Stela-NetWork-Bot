...
for (const folder of commandFolders) {
  ...
  for (const file of commandFiles) {
    ...
    if (command.enabled) {
      // Support cả slash commands (command.data.name) và prefix commands (command.name)
...
require('./autoreply.js')(client);
require('./mcstatus.js')(client);
require('./cmd_status.js')(client);
